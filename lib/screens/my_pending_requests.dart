...
class My_pending_requests extends StatefulWidget {
  const My_pending_requests({Key? key}) : super(key: key);

  @override
  State<My_pending_requests> createState() => _My_pending_requestsState();
}

class _My_pending_requestsState extends State<My_pending_requests> {
  var login_id;
  Future getData() async {
    SharedPreferences spref=await SharedPreferences.getInstance();
    login_id=spref.getString('id');
    var data = await MyPendingRequests.getData(login_id);
    return data;
  }
  markComplete(id){
